...
class PENSConfig
{
     ...
     * @var array
     */
    public static $allowed_commands = ["collect", "receipt", "alert"];
    
    /**
     * Allowed package types
     * @var array
     */
    public static $allowed_package_types = ["aicc-pkg", "scorm-pif", "ims-qti"];
    
    /**
     * Allowed package formats
     * @var array
     */
    public static $allowed_package_formats = ["zip", "url", "jar", "war", "xml"];
