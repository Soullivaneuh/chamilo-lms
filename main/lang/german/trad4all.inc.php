...
$MobilePhoneNumberWrong = "Mobiltelefonnummer ist unvollständig oder enthält ungültige Zeichen";
$CountryDialCode = "Bitte Landesvorwahl angeben";
$FieldTypeMobilePhoneNumber = "Mobiltelefonnummer";
$CheckUniqueEmail = "Eindeutige E-Mail prüfen";
$EmailUsedTwice = "Diese E-Mail ist nicht verfügbar";
$TotalPostsInAllForums = "Alle Beiträge in allen Foren gesamt";
$AddMeAsCoach = "Mich als Trainer hinzufügen";
$AddMeAsTeacherInCourses = "Mich als Lehrer in den importierten Kursen hinzufügen.";
$ExerciseProgressInfo = "Fortschritt der von den Kursteilnehmern durchgeführten Übungen.";
$CourseTimeInfo = "Im Kurs verbrachte Zeit";
$ExerciseAverageInfo = "Durchschnitt der besten Noten für jeden Übungsversuch";
$ExtraDurationForUser = "Zusätzliche Tage Zugriff für diesen Benutzer";
$UserXSessionY = "Benutzer: %s - Sitzung: %s";
$DurationIsSameAsDefault = "Die angegebene Sitzungsdauer ist die gleiche wie der Standard für die Sitzung. Wird ignoriert.";
$FirstAccessWasXSessionDurationYEndDateWasZ = "Der erste Zugriff des Benutzers auf diese Sitzung war am %s. Die Sitzungsdauer beträgt %s Tage, der Zugriff auf diese Sitzung ist bereits am %s abgelaufen";
$FirstAccessWasXSessionDurationYEndDateInZDays = "Der erste Zugriff des Benutzers auf diese Sitzung war am %s. Die Sitzungsdauer beträgt %s Tage, das Enddatum ist demnach in %s Tagen";
$UserNeverAccessedSessionDefaultDurationIsX = "Dieser Benutzer hat vorher noch nie auf diese Sitzung zugegriffen. Die Dauer ist derzeit auf %s Tage (ab dem Datum des ersten Zugriffs) festgelegt.";
$SessionDurationEdit = "Sitzungsdauer bearbeiten";
$EditUserSessionDuration = "Bearbeitung Benutzer-Sitzungsdauer";
$SessionDurationXDaysLeft = "Diese Sitzung hat eine maximale Laufzeit. Es verbleiben nur noch %s Tage.";
$NextTopic = "Nächstes Thema";
$CurrentTopic = "Aktuelles Thema";
$ShowFullCourseAdvance = "Kursplanung anzeigen";
$RedirectToCourseHome = "Zur Kurs-Homepage umleiten";
$LpReturnLink = "Zurück-Link im Lernpfad";
$LearningPathList = "Lernpfadliste";
$UsersWithoutTask = "Kursteilnehmer, die ihre Arbeit nicht gesendet haben";
$UsersWithTask = "Kursteilnehmer, die ihre Arbeit gesendet haben";
$UploadFromTemplate = "Von Vorlage hochladen";
$DocumentAlreadyAdded = "Dokument bereits hinzugefügt";
$AddDocument = "Dokument hinzufügen";
$ExportToDoc = "Als .doc exportieren";
$SortByTitle = "Nach Titel ordnen";
$SortByUpdatedDate = "Nach Ausgabedatum ordnen";
$SortByCreatedDate = "Nach Erstellungsdatum ordnen";
...
$QuestionId = "Frage-ID";
$ExerciseId = "Übungs-ID";
$ExportExcel = "Excel-Export";
$CompanyReportResumed = "Unternehmensbericht, kurze Version";
$CompanyReport = "Unternehmensbericht";
$Report = "Bericht";
$TraceIP = "IP verfolgen";
$NoSessionProvided = "Keine Sitzung verfügbar";
$UserMustHaveTheDrhRole = "Benutzer müssen die HR-Direktor-Rolle besitzen";
$NothingToAdd = "Nichts hinzuzufügen";
$NoStudentsFoundForSession = "Kein Teilnehmer für die Sitzung gefunden";
$NoDestinationSessionProvided = "Keine Ziel-Sitzung verfügbar";
$SessionXSkipped = "Sitzung %s übersprungen";
$CheckDates = "Termine prüfen";
$CreateACategory = "Eine Kategorie erstellen";
$PriorityOfMessage = "Nachrichtentyp";
$ModifyDate = "Änderungsdatum";
$Weep = "Weep";
$LatestChanges = "Letzte Änderungen";
$FinalScore = "Endpunktzahl";
$ErrorWritingXMLFile = "Fehler beim Schreiben der XML-Datei. Bitten Sie den Administrator, die Fehlerprotokolle zu überprüfen.";
$TeacherXInSession = "Lehrer in der Sitzung: %s";
$DeleteAttachment = "Anhang löschen";
$EditingThisEventWillRemoveItFromTheSerie = "Durch die Bearbeitung dieses Ereignisses wird dieses aus der Serie von Ereignissen, denen es derzeit angehört, entfernt";
$EnterTheCharactersYouReadInTheImage = "Geben Sie die Zeichen ein, die Sie auf dem Bild sehen";
$YouDontHaveAnInstitutionAccount = "Sie haben kein institutionelles Konto";
$LoginWithYourAccount = "Mit Ihrem Konto anmelden";
$YouHaveAnInstitutionalAccount = "Sie haben bereits ein institutionelles Konto";
...
$AgendaList = "Terminliste";
$Calendar = "Kalender";
$CustomRange = "Benutzerdefinierter Bereich";
$ThisWeek = "Diese Woche";
$SendToUsersInSessions = "An alle Benutzer in allen Sitzungen des Kurses senden";
$ParametersNotFound = "Parameter nicht gefunden";
$UsersToAdd = "Hinzuzufügende Benutzer";
$DocumentsAdded = "Dokumente hinzugefügt";
$NoUsersToAdd = "Keine hinzuzufügenden Benutzer";
$StartSurvey = "Fragebogen starten";
$Subgroup = "Untergruppe";
$Subgroups = "Untergruppen";
$EnterTheLettersYouSee = "Geben Sie die Buchstaben ein, die Sie sehen.";
$ClickOnTheImageForANewOne = "Klicken Sie auf das Bild, um ein neues zu laden.";
$AccountBlockedByCaptcha = "Konto von Captcha gesperrt.";
$CatchScreenCasts = "Screenshot/Screencast festhalten";
$View = "Anzeigen";
$AmountSubmitted = "Eingereichte Anzahl";
$InstallWarningCouldNotInterpretPHP = "Achtung: Das Installationsprogramm hat beim Versuch, die Testdatei auf %s zu erreichen, einen Fehler festgestellt. Scheinbar konnte das PHP-Skript nicht interpretiert werden. Dies könnte ein Warnhinweis auf zukünftige Probleme bei der Erstellung von Kursen sein. Bitte lesen Sie die Installationsanleitung für weitere Informationen zu Berechtigungen. Wenn Sie eine Website mit einer URL installieren, die sich noch nicht auflöst, können Sie diese Meldung wahrscheinlich ignorieren.";
$BeforeX = "Vor %s";
$AfterX = "Nach %s";
$ExportSettingsAsXLS = "Einstellungen als XLS exportieren";
$DeleteAllItems = "Alle Elemente löschen";
$DeleteThisItem = "Dieses Element löschen";
$RecordYourVoice = "Nehmen Sie Ihre Stimme auf";
$RecordIsNotAvailable = "Keine Aufzeichnung verfügbar";
$WorkNumberSubmitted = "Erhaltene Arbeiten";
$ClassIdDoesntExists = "Klassen-ID existiert nicht";
$WithoutCategory = "Ohne Kategorie";
$IncorrectScore = "Falsches Ergebnis";
$CorrectScore = "Korrektes Ergebnis";
$UseCustomScoreForAllQuestions = "Benutzerdefinierte Bewertung für alle Fragen verwenden";
$YouShouldAddItemsBeforeAttachAudio = "Sie sollten Ihrem Lernpfad einige Elemente hinzufügen, sonst können Sie diesen keine Audio-Dateien hinzufügen";
$InactiveDays = "Inaktive Tage";
$FollowedHumanResources = "Gefolgte HR-Leiter";
$TheTextYouEnteredDoesNotMatchThePicture = "Der von Ihnen eingegebene Text entspricht nicht dem Bild.";
$RemoveOldRelationships = "Frühere Beziehungen entfernen";
$ImportSessionDrhList = "Liste der HR-Leiter in Sitzungen importieren";
$FollowedStudents = "Verfolgte Kursteilnehmer";
$FollowedTeachers = "Verfolgte Lehrer";
$AllowOnlyFiles = "Nur Dateien zulassen";
$AllowOnlyText = "Nur Text zulassen";
$AllowFileOrText = "Dateien oder Online-Text zulassen";
$DocumentType = "Dokumenttyp";
$SendOnlyAnEmailToMySelfToTest = "Als Test eine E-Mail an mich versenden.";
$DeleteAllSelectedAttendances = "Alle ausgewählten Anwesenheiten löschen";
$AvailableClasses = "Verfügbare Klassen";
$RegisteredClasses = "Registrierte Klassen";
$DeleteItemsNotInFile = "Elemente, die sich nicht in Datei befinden, löschen";
$ImportGroups = "Gruppen importieren";
$HereIsYourFeedback = "Hier ist Ihr Feedback";
$SearchSessions = "Sitzungs-Suche";
$ShowSystemFolders = "Systemordner anzeigen.";
$SelectADateOnTheCalendar = "Wählen Sie ein Datum aus dem Kalender aus";
$AreYouSureDeleteTestResultBeforeDateD = "Sind Sie sicher, dass Sie Ergebnisse für diesen Test vor dem ausgewählten Datum löschen möchten?";
$CleanStudentsResultsBeforeDate = "Alle Ergebnisse vor einem bestimmten Datum entfernen";
$HGlossary = "Glossar-Hilfe";
$GlossaryContent = "Mit diesem Tool können Sie Glossareinträge für diesen Kurs erstellen, die dann im Dokumenten-Tool verwendet werden können.";
$HForum = "Forum Hilfe";
$LoginToGoToThisCourse = "Bitte melden Sie sich an, um zu diesem Kurs zu gelangen";
$AreYouSureToEmptyAllTestResults = "Die Ergebnisse aller Teilnehmer für alle Übungen löschen?";
$CleanAllStudentsResultsForAllTests = "Sind Sie sicher, dass alle Testergebnisse gelöscht werden sollen?";
$AdditionalMailWasSentToSelectedUsers = "Darüber hinaus wurde eine neue Ankündigung erstellt und an ausgewählte Benutzer gesendet";
$LoginDate = "Login-Datum";
$ChooseStartDateAndEndDate = "Start- und Enddatum wählen";
$TestFeedbackNotShown = "Dieser Test ist so konfiguriert, dass Teilnehmern kein Feedback angezeigt wird. Kommentare werden am Ende des Tests nicht angezeigt, können jedoch für Sie, als Lehrer, bei der Überprüfung der Frage nützlich sein.";
$WorkAdded = "Arbeit hinzugefügt";
...
$InactiveUsers = "Benutzer, deren Konto deaktiviert wurde.";
$ActiveUsers = "Benutzer mit einem aktiven Konto";
$SurveysProgress = "Fragebogen-Fortschritt";
$SurveysLeft = "Unvollständige Fragebögen";
$SurveysDone = "Abgeschlossene Fragebögen";
$SurveysTotal = "Fragebögen insgesamt";
$WikiProgress = "Fortschritt gelesene Wiki-Seiten";
$WikiUnread = "Wiki-Seiten ungelesen";
$WikiRead = "Wiki-Seiten gelesen";
$WikiRevisions = "Wiki-Seiten-Revisionen";
$WikiTotal = "Wiki-Seiten insgesamt";
$AssignmentsProgress = "Fortschritt Aufgaben";
$AssignmentsLeft = "Fehlende Aufgaben";
$AssignmentsDone = "Abgeschlossen und eingereicht";
$AssignmentsTotal = "Aufgaben insgesamt";
$ForumsProgress = "Fortschritt Foren";
$ForumsLeft = "Ungelesene Foren";
$ForumsDone = "Gelesene Foren";
$ForumsTotal = "Foren gesamt";
$ExercisesProgress = "Fortschritt Übungen";
$ExercisesLeft = "Unvollständige Übungen";
$ExercisesDone = "Abgeschlossene Übungen";
$ExercisesTotal = "Übungen insgesamt";
$LearnpathsProgress = "Fortschritt Lernpfade";
$LearnpathsLeft = "Unvollständige Lernpfade";
$LearnpathsDone = "Abgeschlossene Lernpfade";
$LearnpathsTotal = "Lernpfade insgesamt";
$TimeLoggedIn = "Verbundene Zeit (ss:mm)";
$SelectSurvey = "Fragebogen auswählen";
$SurveyCopied = "Fragebogen kopiert";
$NoSurveysAvailable = "Keine Fragebögen verfügbar";
$DescriptionCopySurvey = "Eine leere Fragebogen-Kopie in einen anderen Kurs duplizieren Sie benötigen 2 Kurse, um diese Funktion zu nutzen: einen Original-Kurs und einen Ziel-Kurs.";
$CopySurvey = "Fragebogen kopieren";
$ChooseSession = "Bitte wählen Sie eine Sitzung";
$SearchSession = "Sitzungen durchsuchen";
$ChooseStudent = "Bitte wählen Sie einen Kursteilnehmer";
$SearchStudent = "Benutzer suchen";
$ChooseCourse = "Bitte wählen Sie einen Kurs";
$DisplaySurveyOverview = "Übersicht Fragebögen";
$DisplayProgressOverview = "Übersicht Teilnahme und Lesefortschritt";
$DisplayLpProgressOverview = "Übersicht Lernpfad-Fortschritt";
$DisplayExerciseProgress = "Detaillierte Übungen Fortschritte";
$DisplayAccessOverview = "Übersicht Zugriffe durch Benutzer";
...
$CoachesSubscribedAsATeacherInCourseX = "Als Lehrer im Kurs %s angemeldete Trainer";
...
$AddUserGroupToThatURL = "Benutzergruppe zu dieser URL hinzufügen";
$FirstLetter = "Erster Buchstable";
$UserGroupList = "Benutzergruppenliste";
$AddUserGroupToURL = "Gruppe zu URL hinzufügen";
$UserGroupListInX = "Gruppen in %s";
$UserGroupListInPlatform = "Plattformgruppenliste";
$EditUserGroupToURL = "Gruppen für eine URL bearbeiten";
$ManageUserGroup = "Benutzergruppen verwalten";
$FolderDoesntExistsInFileSystem = "Zielordner ist auf dem Server nicht vorhanden.";
$RegistrationDisabled = "Es tut uns leid, Sie versuchen gerade, die Anmeldungs-Seite für dieses Portal aufzurufen, aber die Anmeldung ist derzeit deaktiviert. Bitte kontaktieren Sie den Administrator (siehe Kontaktdaten in der Fußzeile). Wenn Sie bereits ein Konto auf dieser Site haben.";
...
$ExerciseAutoLaunch = "Auto-Start für Übungen";
$AllowFastExerciseEdition = "Schnellen Übungsbearbeitungsmodus aktivieren";
$Username = "Benutzername";
$SignIn = "Eintragen";
$YouAreReg = "Sie sind registriert bei";
$ManageQuestionCategories = "Verwalten globaler Fragen Kategorien";
$ManageCourseFields = "Zusätzliche Felder für Kurse verwalten";
$ManageQuestionFields = "Zusätzliche Felder für Fragen verwalten";
$QuestionFields = "Fragenfelder";
$FieldLoggeable = "Feldänderungen sollten protokolliert werden";
$EditExtraFieldWorkFlow = "Den Workflow in diesem Feld bearbeiten";
$SelectRole = "Rolle auswählen";
$SelectAnOption = "Bitte wähle eine Option";
$CurrentStatus = "Aktueller Status";
$MyCourseCategories = "Meine Kurse Kategorien";
$SessionsCategories = "Sessions Kategorien";
$CourseSessionBlock = "Kurse und Sessions";
$Committee = "Ausschuss";
$ModelType = "Übungsmodell Typ";
$AudioFile = "Audiodatei";
$CourseVisibilityHidden = "Versteckt - nur für Administratoren sichtbar";
$HandedOutDate = "Zeit des Empfangs";
$HandedOut = "Ausgestelt";
$HandOutDateLimit = "Frist";
$ApplyAllLanguages = "Änderungen auf alle Sprachen anwenden";
$ExerciseWasActivatedFromXToY = "Übung wurde von %s bis %s aktiviert";
$YourPasswordCannotBeTheSameAsYourUsername = "Ihr Passwort kann nicht mit Ihrem Benutzernamen übereinstimmen";
$CheckEasyPasswords = "Überprüfe Passwörter zu leicht zu erraten";
...
$ConvertToMultipleAnswer = "Konvertieren zu mehrere Antworten";
...
$PreventSessionAdminsToManageAllUsersTitle = "Verhindern, dass Sitzungs-Administratoren alle Benutzer verwalten können";
$IsOpenSession = "Offene Sitzung";
$AllowVisitors = "Besucher zulassen";
...
$CourseKwds = "Dieses Dokument enthält die Schlagworte für den Kurs";
...
$TimeSpentByStudentsInCourses = "Zeitaufwand von Studenten in den Kursen";
...
$Titular = "Kursleiter";
$SendToAllUsers = "An alle Benutzer senden";
...
$AllDay = "Ganztägig";
$PublicationStartDate = "Veröffentlichtes Startdatum";
$ShowStatus = "Status anzeigen";
$Mode = "Modus";
$Schedule = "Zeitplan";
$Place = "Ort/Lage";
$RecommendedNumberOfParticipants = "Empfohlene Teilnehmerzahl";
...
$MetaTwitterCreatorComment = "Der Twitter-Creator ist ein Twitter-Konto (z.B. @ywarnier), der die *Person*, die die Website erstellt hat, repräsentiert. Dieses Feld ist optional.";
...
$MetaImagePathTitle = "Meta-Image-Pfad";
...
$PDFDownloadNotAllowedForStudents = "PDF-Download ist für Studierende nicht zulässig.";
...
$ShowStudentViewComment = "Soll die Funktion Teilnehmer-Ansicht aktiviert werden? <br>Diese Funktion gestattet es dem Lehrenden, die Seite so zu sehen, wie sie ein/e Kursteilnehmer/in sie sieht.";
...
$MetaTwitterSiteTitle = "Twitter-Site Konto";
$Languages = "Sprachen";
...
$UpgradeFromLMS19x = "Upgrade von LMS v1.9.*";
$SignUp = "Anmelden!";
...
$AlreadyRegisteredToSession = "Bereits in der Session registriert";
...
$CannotUnsubscribeUserFromCourse = "Kann Benutzer nicht vom Kurs abmelden, da er ein Kursleiter ist.";
...
$MetaTwitterCreatorTitle = "Twitter Creator Konto";
...
$EnterStudentsToSubscribeToCourse = "Teilnehmer eingeben, die in den Kurs eingetragen werden sollen";
...
$MetaTitleTitle = "OpenGraph Meta-Titel";
$MetaDescriptionComment = "Dies zeigt eine Beschreibung der OpenGraph Meta (og:Beschreibung) in Ihrem Website-Header an";
$MetaDescriptionTitle = "Meta-Beschreibung";
$MetaTitleComment = "Dies zeigt eine OpenGraph Titel Meta (og:Titel) in Ihrem Website-Header an";
...
$ToExportSpecialSelect = "Wenn Sie Kurse exportieren möchten, die Kurs-Sessions enthalten, stellen Sie sicher, dass diese Kurs-Sessions auch in der Export-Auswahl enhalten sind.";
...
$CreateGroupsFromVirtualCoursesInfo = "Dieser Kurs ist eine Kombination eines wirklichen Kurses mit einem oder mehreren virtuellen Kursen. Wenn Sie den folgenden Button klicken, werden neue Gruppen gemäß dieses(dieser) Kurse (virutellen Kurse) angelegt. Alle Teilnehmer werden in die Gruppen eingetragen.";
...
$OpenBadgesTitle = "Chamilo unterstützt den OpenBadges-Standard";
$NoPosts = "Keine Beiträge";
$WithoutAchievedSkills = "Keine erworbenen Fertigkeiten";
$TypeMessage = "Bitte geben Sie Ihre Mitteilung ein!";
$ConfirmReset = "Möchten sie wirklich alle Mitteilungen löschen?";
$MailCronCourseExpirationReminderBody = "Liebe/r %s,";
$MailCronCourseExpirationReminderSubject = "Dringend: Ablauferinnerung für %s-Kurs";
$ExerciseAndLearningPath = "Übung und Lernpfad";
$LearningPathGradebookWarning = "Warnung: Es ist möglich, dass im Ergebnisspiegel Tests verwendet werden, die Teil von Lernpfaden sind. Ist der Lernpfad selbst bereits enthalten, könnte dieser Test bereits Teil des Ergebnisspiegels sein. Die Lernpfad-Auswertung erfolgt auf Grundlage prozentualer Fortschritte, während die Auswertung von Tests auf Grundlage einer Punktzahl erfolgt. Die Fragebogen-Auswertung basiert darauf, ob der Benutzer geantwortet (1) oder nicht geantwortet (0) hat. Stellen Sie sicher, dass Sie Ihre Kombinationen von Ergebnisspiegel-Auswertungen zunächst testen, um verwirrende Situationen zu vermeiden.";
$ChooseEitherDurationOrTimeLimit = "Wählen Sie entweder Dauer oder zeitliche Begrenzung aus";
$ClearList = "Liste leeren";
$SessionBanner = "Sitzungsbanner";
$ShortDescription = "Kurze Beschreibung";
$TargetAudience = "Zielgruppe";
$OpenBadgesActionCall = "Konvertieren Sie Ihren virtuellen Campus zu einer fertigkeitsorientierten Lernerfahrung";
...
$Forums = "Foren";
$GradebookListOfStudentsReports = "Teilnehmerlistenbericht";
...
$Up = "höhere Ebene";
$Down = "nach unten";
$TimeReportForCourseX = "Bericht zur Stundenanzahl für Kurs %s";
...
$TimeReportForTeacherX = "Bericht zur Stundenanzahl für Lehrer %s";
...
$DisplayCertificate = "Zertifikat anzeigen";
$Doc = "Dokument";
...
$TimeReportForSessionX = "Bericht zur Stundenanzahl für Sitzung %s";
$Error = "Fehler";
$Anonymous = "Anonym";
$h = "h";
...
$PreventSessionAdminsToManageAllUsersComment = "Durch Aktivieren dieser Option werden Sitzungs-Admins auf der Verwaltungsseite nur die Benutzer angezeigt, die sie erstellt haben.";
...
$UserAlreadyRegistered = "Ein Teilnehmer mit dem gleiche Vor- und Nachnamen ist für diesen Kurs bereits angemeldet.";
...
$ConvertToUniqueAnswer = "Zu eindeutiger Antwort konvertieren";
$ReportsRequiresNoSetting = "Dieser Bericht erfordert keine Einstellungen";
$ShowWizard = "Assistent anzeigen";
$ReportFormat = "Berichtsformat";
$ReportType = "Berichtstyp";
$PleaseChooseReportType = "Bitte wählen Sie einen Berichtstyp";
$PleaseFillFormToBuildReport = "Bitte füllen Sie das Formular aus, um den Bericht zu erstellen";
$UnknownFormat = "Unbekanntes Format";
$ErrorWhileBuildingReport = "Fehler beim Erstellen des Berichts";
...
$AddPagesLocked = "Hinzufügen Option wurde vom Kursadministrator momentan ausgeschaltet";
$LinksPages = "Verweise";
...
$YouNeedToActivateTheGoogleMapsPluginInAdminPlatformToSeeTheMap = "Das GoogleMaps-Plugin muss durch den Plattform-Administrator aktiviert sein, um die Karte anzuzeigen.";
$HClar = "Hilfe starten";
...
$IsInductionSession = "Einführungs-Sitzung";
...
$Brochure = "Broschüre";
$SlideShow = "Diashow";
$PublicationEndDate = "Enddaten der Veröffentlichung";
...
$AsciiSvgComment = "Aktivieren Sie das AsciiSVG-Plugin im WYSIWYG-Editor, um Diagramme von mathematischen Funktionen zu erstellen.";
...
$QuestionsOverallReportDetail = "In diesem Bericht sehen Sie die Ergebnisse aller Fragen";
$QuestionsOverallReport = "Fragen Gesamtbericht";
...
$BlogsContent = "<p>Das Projekt-Werkzeug ermöglicht es den Kursteilnehmern, Wissen kollaborativ durch Rollen, Aufgaben und Fristen zu erwerben.";
...
$TheTimeLimitsAreReferential = "Das Zeitlimit einer Kategorie ist referentiell. Es beeinflusst nicht die Limits der Kurs-Session.";
...
$DurationInWords = "Dauer in Worten";
$UploadCorrection = "Korrektur hochladen";
...
$ExerciseWithFeedbackWithoutCorrectionComment = "Hinweis: Dieser Test wurde eingerichtet um die erwarteten Antworten zu verbergen.";
...
$AsciiSvgTitle = "AsciiSVG aktivieren";
...
$Enabled = "aktiviert";
$ThematicAdvanceQuestions = "Was ist das aktuelle Ziel, der aktuelle (Fort-)Schritt, den Sie mit Ihren Teilnehmern bis hier erreicht haben? Wie groß ist der Teil der Ziele / Schritte die bezogen auf den gesamten Kurs noch verbeleiben? Wie viel ist geschafft, was liegt noch vor uns?";
...
$LoginEnter = "Login";
$AssignSessionsToX = "Ordne Kurs-Session zu %s zu";
...
$AssignCoursesToSessionsAdministrator = "Kurse zu Kurs-Session-Leiter zuordnen";
$AssignCoursesToPlatformAdministrator = "Kurse zu Administratoren zuordnen";
...
$AssignedSessionsListToPlatformAdministrator = "Liste der zu Administratoren zugeordneten Kurs-Sessions";
...
$ExportSelectedCoursesFromCoursesList = "Alle ausgewählten Kurse der folgenden Liste exportieren";
...
$AssignedCoursesListToHumanResourcesManager = "Kurse die dem Personalverantwortlichen zugeordnet sind";
...
$StudentBoss = "Vorgesetzter (n +1)";
$EnableMathJaxComment = "Aktivieren Sie die MathJax-Bibliothek, um mathematische Formeln zu visualisieren. Dies ist nur sinnvoll, wenn entweder ASCIIMathML oder ASCIISVG Einstellungen aktiviert sind.";
...
$CourseRequestUpdateFailed = "Die Kurserstellungsanfrage %s wurde wegen eines internen Fehlers nicht aktualisiert.";
$CourseRequestUpdated = "Die Kurserstellungsanfrage %s wurde aktualisiert.";
...
$Video = "Video";
$Images = "Bilder";
$UploadCorrections = "Korrekturen hochladen";
...
$ShowChatFolderComment = "Dem Kursleiter das Verzeichnis ' Abgelaufene Chat-Unterhaltungen' (Chat conversations history) anzeigen. Es beinhaltet Mitschnitte aller angelaufenen Chatsitzungen. Der Kursleiter kann Sie für die Kursteilnehmer sichtbar machen oder nicht und sie als Quelle verwenden.";
...
$EnableMathJaxTitle = "MathJax aktivieren";
$Activate = "Aktivieren";
...
$PromotionXUnarchived = "Die <i>%s</i> Qualifikation wurde aus dem Archiv entfernt. Diese Aktion hat zur Folge das alle zugeordneten Kurs-Sessions wieder sichtbar sind. Sie können dies rückgängig machen, indem Sie diese Qualifikation archivieren.";
...
$EnableQuizScenarioComment = "Hiermit können Sie Test erzeugen, welche zu unterschiedlichen Fragen führen, je nach dem, wie der Teilnehmer geantwortet hat.";
...
$AtLeastOneSessionAndOneURL = "Sie müssen mindestens eine Kurs-Session und eine URL auswählen.";
$SelectURL = "URL auswählen";
...
$UnlockMessageInformation = "Die Anwesenheit ist nicht gesperrt, was bedeutet, dass der Kursleiter die Anwesenheit noch ändern kann.";
...
$EnablePasswordStrengthCheckerText = "Kennwortstärke-Prüfer";
...
$CaptchaNumberOfMistakesBeforeBlockingAccountText = "CAPTCHA Fehlerzulage";
...
$HideScormExportLinkTitle = "SCORM-Export ausblenden";
$HideScormExportLinkComment = "„SCORM Export“-Symbol in der Lernpfadliste ausblenden";
$HideScormCopyLinkTitle = "SCORM-Kopie ausblenden";
$HideScormCopyLinkComment = "Das „Lernpfad-Kopie“-Symbol in der Lernpfadliste ausblenden";
$HideScormPdfLinkTitle = "Lernpfad PDF-Export ausblenden";
...
$LearningPathShowReducedReportTitle = "Lernpfade: Kurzbericht anzeigen";
...
$HideLogoutButtonTitle = "Logout-Schaltfläche ausblenden";
...
$CookieWarningTitle = "Cookie-Datenschutzhinweis";
...
$SoapRegistrationDecodeUtf8Title = "Web-Dienste: UTF-8 entschlüsseln";
...
$AttendanceDeletionEnableTitle = "Anwesenheit: Löschen aktivieren";
...
$GravatarPicturesTitle = "Gravatar Benutzerbilder";
...
$GravatarPicturesTypeTitle = "Gravatar Avatartyp";
...
$ShowSessionDescriptionTitle = "Sitzungsbeschreibung anzeigen";
...
$DropboxHideCourseCoachTitle = "Dropbox: Kurstrainer ausblenden";
$DropboxHideCourseCoachComment = "Den Sitzungs-Kurstrainer in Dropbox ausblenden, wenn ein Dokument vom Trainer an Kursteilnehmer versendet wird.";
$SSOForceRedirectTitle = "Einmaliges Anmelden: Umleitung erzwingen";
...
$SetAsRequirement = "Als Voraussetzung festlegen";
$AddSequence = "Neue Sequenz hinzufügen";
$ResourcesSequencing = "Ressourcen-Sequenzierung";
$GamificationModeTitle = "Gamification-Modus";
$GamificationModeComment = "Sterne-Leistung in Lernpfaden aktivieren";
$LevelX = "Stufe %s";
$SeeCourse = "Kurs anzeigen";
$XPoints = "%s Punkte";
$FromXUntilY = "Von %s bis %s";
$SubscribeUsersToLp = "Nutzer zum Lernpfad hinzufügen";
$SubscribeGroupsToLp = "Gruppen zum Lernpfad hinzufügen";
$CreateForumForThisLearningPath = "Forum für diesen Lernpfad erstellen";
$ByDate = "Nach Datum";
$ByTag = "Nach Tag";
$GoToCourseInsideSession = "Zu Kurs innerhalb einer Sitzung wechseln";
$EnableGamificationMode = "Gamification-Modus aktivieren";
$MyCoursesSessionView = "Ansicht „Meine Kurs-Sitzung“";
$DisableGamificationMode = "Gamification-Modus deaktivieren";
...
$DistinctUsersLogins = "Eindeutige Benutzer-Logins";
...
$CronCourseFinishedActivateText = "Cron „Kurs beendet“";
$CronCourseFinishedActivateComment = "Den Cron „Kurs beendet“ aktivieren";
$MailCronCourseFinishedSubject = "Ende des Kurses %s";
$MailCronCourseFinishedBody = "Liebe/r %s,";
$GenerateDefaultContent = "Standardinhalte generieren";
...
$FieldTypeAlphanumeric = "Nur alphanumerische Zeichen";
...
$PreventMultipleSimultaneousLoginTitle = "Gleichzeitigen Login verhindern";
...
$CourseCatalogIsPublicTitle = "Kursverzeichnis veröffentlichen";
$CourseCatalogIsPublicComment = "Machen Sie das Kursverzeichnis für anonyme Benutzer (der Öffentlichkeit) ohne Anmeldung verfügbar.";
$ResetPasswordTokenTitle = "Kennwortzurücksetzungstoken aktivieren";
...
$SkillXEnabled = "Fertigkeit \"%s\" aktiviert";
$SkillXDisabled = "Fertigkeit \"%s\" deaktiviert";
...
$LocalConnectionFailed = "Lokale Verbindung fehlgeschlagen";
$RemoteConnectionFailed = "Remote-Verbindung fehlgeschlagen";
$ViewStudents = "Kursteilnehmer anzeigen";
$Into = "In";
$Sequence = "Sequenz";
$Invitee = "Eingeladene";
...
$GroupReporting = "Gruppen-Berichterstellung";
$ConvertFormats = "Format konvertieren";
$AreYouSureToDeleteX = "Sind Sie sicher, dass Sie %s löschen möchten?";
$AttachmentList = "Liste der Anhänge";
$SeeCourseInformationAndRequirements = "Kursinformationen und Anforderungen anzeigen";
$DownloadAll = "Alle herunterladen";
$DeletedDocuments = "Gelöschte Dokumente";
$CourseListNotAvailable = "Kursliste nicht verfügbar";
$CopyOfMessageSentToXUser = "Kopie der Nachricht an %s gesendet";
$Convert = "Konvertieren";
$PortalLimitType = "Art des Limits des Portals";
$PortalName = "Portalname";
$BestScore = "Beste Note";
$AreYouSureToDeleteJS = "Möchten Sie wirklich löschen?";
$ConversionToSameFileFormat = "Konvertierung zum gleichen Dateiformat. Bitte wählen Sie ein anderes Format.";
$FileFormatNotSupported = "Dateiformat nicht unterstützt";
$FileConvertedFromXToY = "Datei konvertiert von %s auf %s";
$XDays = "%s Tage";
$SkillProfile = "Fertigkeitsprofil";
$AchievedSkills = "Erworbene Fertigkeiten";
$BusinessCard = "Visitenkarte";
$BadgeDetails = "Abzeichendetails";
$TheUserXNotYetAchievedTheSkillX = "Der Benutzer %s hat die Fähigkeit \"%s\" noch nicht erworben.";
$IssuedBadgeInformation = "Ausgestellte Abzeicheninformationen";
$RecipientDetails = "Empfängerangaben";
$SkillAcquiredAt = "Fertigkeit erworben durch";
$BasicSkills = "Grundlegende Fertigkeiten";
$TimeXThroughCourseY = "%s bis %s";
$ExportBadge = "Abzeichen exportieren";
$SelectToSearch = "Auswählen, um zu suchen";
$PlaceOnTheWheel = "Dem Diagramm hinzufügen";
$Skill = "Fertigkeit";
$Argumentation = "Argumentation";
$TheUserXHasAlreadyAchievedTheSkillY = "Der Benutzer %s hat die Fertigkeit %s bereits erworben";
$SkillXAssignedToUserY = "Die Fertigkeit %s wurde dem Benutzer %s zugewiesen";
$AssignSkill = "Fertigkeit zuweisen";
$AddressField = "Adresse";
$Geolocalization = "Geolokalisierung";
$RateTheSkillInPractice = "Auf eine Notenskala von 1 bis 10, wie gut hat diese Person diese Fertigkeit in der Praxis eingesetzt?";
$AverageRatingX = "Durchschnittliche Bewertung %s";
$AverageRating = "Durchschnittliche Bewertung";
$GradebookTeacherResultsNotShown = "Kursleiterergebnisse werden im Ergebnisspiegel nicht angezeigt oder berücksichtigt.";
$SocialWallWriteNewPostToFriend = "Schreiben Sie etwas auf die Pinnwand Ihres Freundes";
$EmptyTemplate = "Leere Vorlage";
$BaseCourse = "Basiskurs";
$BaseCourses = "Basiskurse";
$Square = "Viereck";
$Ellipse = "Ellipse";
$Polygon = "Polygon";
$HotspotStatus1 = "Einen Hotspot zeichnen";
$HotspotStatus2Polygon = "Klicken Sie mit der rechten Maustaste, um das Polygon zu schließen";
$HotspotStatus2Other = "Lassen Sie die Maustaste los, um den Hotspot zu speichern";
$HotspotStatus3 = "Hotspot gespeichert";
$HotspotShowUserPoints = "Userclicks anzeigen/ausblenden";
$ShowHotspots = "Hotspots anzeigen/ausblenden";
$Triesleft = "Verbleibende Versuche";
$NextAnswer = "Klicken Sie jetzt auf:";
$CloseDelineation = "Darstellung schließen";
$Oar = "Gefährdeter Bereich";
...
$ResetToTheOriginalLogo = "Original-Logo wiederhergestellt";
$NewLogoUpdated = "Neues Logo hochgeladen";
...
$EnableForumAutoLaunch = "Forum Auto-Start aktivieren";
...
$UserXIndicated = "Benutzer %s hat angegeben:";
$AcquiredLevel = "Erworbene Stufe";
$ManageSkillsLevels = "Fertigkeitsstufe verwalten";
$AddProfile = "Profil hinzufügen";
$AddLevel = "Stufe hinzufügen";
$ChangeAcquiredLevel = "Erworbene Stufe ändern";
$NoLevelAcquiredYet = "Noch keine Stufe erworben";
$RecordAudio = "Audio aufzeichnen";
$StartRecordingAudio = "Aufnahme starten";
$StopRecordingAudio = "Aufnahme beenden";
$SaveRecordedAudio = "Aufgezeichnetes Audio speichern";
$GradeFromX = "Noten vom Kurs: %s";
$TitleMandatory = "Ein Titel ist erforderlich";
$NoCourseCategorySupplied = "Es wurde keine Kurskategorie angegeben";
$ForumStartDate = "Datum der Veröffentlichung";
$ForumEndDate = "Abschlussdatum";
$ForumStartDateComment = "Das Forum ist ab diesem Datum sichtbar";
$ForumEndDateComment = "Nach Ablauf dieses Datums wird das Forum geschlossen";
$ModeratedForum = "Moderiertes Forum";
$DiagnosisFilledSubject = "Diagnose erfolgreich ausgefüllt";
$DiagnosisFilledDescription = "Die Diagnose wurde erfolgreich ausgefüllt";
$UserXHasFilledTheDiagnosis = "Benutzer %s hat die Diagnose ausgefüllt.";
$UserXHasFilledTheDiagnosisDescription = "Benutzer %s hat die Diagnose auf der Plattform ausgefüllt und wartet auf Ihre Überprüfung.";
$SendLegal = "Rechtliche Vereinbarung senden";
$DeleteLegal = "Rechtliche Vereinbarung löschen";
$LegalAccepted = "Rechtliche Vereinbarung akzeptiert";
...
$LaunchVideoConferenceRoom = "Videokonferenzraum starten";
...
$UpdateExistingGlossaryTerms = "Vorhandene Begriffe aktualisieren";
$TermsUpdated = "Begriffe aktualisiert";
$TermsAdded = "Begriffe hinzugefügt";
$TeacherTimeReportBySession = "Zeitbericht der Kursleiter nach Sitzung";
$NumberOfWorks = "Anzahl der Arbeiten";
$LastWork = "Letzte Arbeit";
$WaitingModeration = "Wartet auf Moderation";
$WorksInSessionReport = "Arbeiten im Sitzungsbericht";
$Files = "Dateien";
$AssignedTo = "Zugewiesen zu";
$UpdatedByX = "Von %s aktualisiert";
$AssignedChangeFromXToY = "Bearbeiter von %s zu %s geändert";
$RequestConfirmation = "Bestätigung anfordern";
$ChangeAssign = "Bearbeiter ändern";
$ToBeAssigned = "Zuweisung ausstehend";
$StatusNew = "Neu";
$StatusPending = "Ausstehend";
$StatusUnconfirmed = "Unbestätigt";
$StatusClose = "Schließen";
...
$TicketEnrollment = "Einschreibung";
$TicketGeneralInformation = "Allgemeine Informationen";
$TicketRequestAndPapework = "Anträge und Unterlagen";
$TicketAcademicIncidence = "Akademische Ereignisse";
$TicketVirtualCampus = "Virtueller Campus";
$TicketOnlineEvaluation = "Online-Auswertung";
$TicketsAboutEnrollment = "Tickets zur Einschreibung";
$TicketsAboutGeneralInformation = "Tickets zu allgemeinen Informationen";
$TicketsAboutRequestAndPapework = "Tickets zu Anträgen und Unterlagen";
$TicketsAboutAcademicIncidence = "Tickets zu akademischen Ereignissen, wie Prüfungen, Verfahren, Aufgaben usw.";
$TicketsAboutVirtualCampus = "Tickets zum virtuellen Campus";
$TicketsAboutOnlineEvaluation = "Tickets zur Online-Auswertung";
$Assign = "Zuweisen";
$PersonalEmail = "Persönliche E-Mail";
$Priority = "Priorität";
$Source = "Quelle";
$SrcPlatform = "Plattform";
$SrcEmail = "E-Mail";
$SrcPhone = "Telefon";
$SrcPresential = "Anwesenheit";
$TicketXCreated = "Ticket %s wurde erstellt";
$ShowLinkTicketNotificationTitle = "Ticket-Erstellungs-Link anzeigen";
$ShowLinkTicketNotificationComment = "Benutzern den Ticket-Erstellungs-Link für auf der rechten Seite des Portals anzeigen";
$LastSentWorkDate = "Datum zuletzt gesendete Arbeit";
$SSOSubclassTitle = "Single-Sign-On Unterklasse";
...
$WorksReport = "Aufgabenbericht";
$AccumulateScormTime = "SCORM-Sitzungszeit akkumulieren";
...
$DownloadTasksPackage = "Aufgabenpaket herunterladen";
$UploadCorrectionsPackage = "Korrekturenpaket hochladen";
$IconsModeSVGTitle = "SVG-Symbol-Modus";
...
$EnableRecordAudioTitle = "Audio-Recorder aktivieren";
...
$TicketAllowStudentAddTitle = "Benutzern ermöglichen, Tickets hinzuzufügen";
...
$VisibleToSelf = "Für Sie sichtbar";
$VisibleToOthers = "Für andere sichtbar";
$UpgradeVersion = "Chamilo LMS-Version aktualisieren";
...
$TicketXAssignedToUserX = "Ticket #%s Benutzer %s zugewiesen";
...
$CourseXAdded = "Kurs %s hinzugefügt";
$CurrentPassword = "Aktuelles Kennwort";
$DeleteCorrections = "Alle Korrekturen löschen";
$AllowMyFilesTitle = "Abschnitt „Meine Dateien“ aktivieren";
...
$SocialData = "Daten in sozialen Netzwerken";
$WallMessagesPosted = "Von ihr/ihm verfasste Pinnwand-Nachrichten";
$SeeAccesses = "Zugriffe anzeigen";
...
$ConfigureExerciseVisibilityInCourseTitle = "Aktivieren Sie diese Option, um die Konfiguration „Übung nicht sichtbar“ in Sitzungen der Grundkurs-Stufe zu umgehen.";
$ConfigureExerciseVisibilityInCourseComment = "Zur Aktivierung der Konfiguration „Übung nicht sichtbar“ in Sitzungen der Grundkurs-Stufe und Umgehung der globalen Konfiguration. Ist diese Option nicht eingestellt, wird der globalen Parameter verwendet.";
$ExerciseInvisibleInSessionTitle = "Übung in Sitzung nicht sichtbar";
$ExerciseInvisibleInSessionComment = "Ist eine Übung im Grundkurs sichtbar, wird sie in der Sitzung nicht angezeigt. Ist eine Übung im Grundkurs nicht sichtbar, wird sie in der Sitzung nicht angezeigt.";
$Ongoing = "Fortlaufend";
$Unclosed = "Nicht abgeschlossen";
$AttemptStillOngoingPleaseWait = "Versuch noch nicht abgeschlossen. Bitte warten.";
$MarkAttemptAsClosed = "Versuch als abgeschlossen markieren";
$NewPasswordRequirementsNotMatched = "Das neue Passwort stimmt nicht mit den Mindestanforderungen über die Sicherheit überein";
$NewPasswordRequirementMinXLowercase = "Minimal %s Kleinbuchstaben";
$NewPasswordRequirementMinXUppercase = "Minimal %s Großbuchstaben";
$NewPasswordRequirementMinXNumeric = "Minimal %s numerische (0-9) Zeichen";
$NewPasswordRequirementMinXLength = "Minimal %s Zeichen insgesamt";
$NewPasswordRequirementMaxXLowercase = "Maximale %s Kleinbuchstaben";
