...
$RedirectAdminToCoursesListComment = "O comportamento padrão é enviar os administradores diretamente para o painel de administração (enquanto os professores e alunos são enviados para a lista de cursos ou a homepage plataforma). Habilitar para redirecionar o administrador também a seu/sua lista de cursos.";
...
$RecipientDetails = "Nome do Aluno";
...
$TicketAllowStudentAddTitle = "Permitir a usuários adicionar Título aos Tickets";
...
$SendEmailToTeacherWhenStudentEndQuizOnlyIfOralQuestion = "Enviar e-mail ao professor quando o aluno terminar um exercício somente se uma pergunta oral for respondida.";
$StudentStartExercise = "O Aluno acabou de começar um exercício";
$TempScoreXQuestionsNotCorrectedYet = "Pontuação temporária: %s pergunta (s) em aberto (s) não corrigida (s) ainda.";
$Annotation = "Anotação";
$TeacherPicture = "Foto do Professor";
$FeedbackIfNotCorrect = "Comentário se não correto";
$ScheduledAnnouncements = "Anúncios Programados";
$SpecificDate = "Data especificada para envio";
$BaseDate = "Envio baseado nas datas de início/fim da sessão";
$AfterOrBefore = "Depois ou antes";
$Before = "Antes";
$ScheduleAnnouncementDescription = "Este formulário permite programar anúncios para serem enviados automaticamente para os alunos que estão inscritos em um curso de uma sessão. Há dois tipos de anúncios que podem ser enviados: Data Específica - Neste caso um dia específico é selecionado para o anúncio ser realizado; e Baseado no início/fim da sessão - neste caso, deve ser indicado o numero de dias que deverá ser enviado o anúncio, relacionado a data de início/fim. Também deve ser selecionado se será relacionado a data de início ou de fim. Por exemplo: 3 dias antes da data de início.";
$MandatorySurveyNoAnswered = "Uma pesquisa obrigatória está esperando pela sua resposta. Para entrar neste curso, primeiro você deve completar a pesquisa.";
$ShowPreviousButton = "Mostrar botão \"Anterior\"";
$AllTickets = "Todos os tickets";
$IsMandatory = "Obrigatório?";
$StudentXHasBeenAssignedNewWorkInCourseY = "%s tem uma nova tarefa no curso %s";
$AsHRMYouReceiveThisMailToAlertThatXHasNewWorkInCourseY = "Como gerente de recursos humanos deste aluno, você está recebendo este email para saber que %s acabou se receber uma nova tarefa no curso %s";
$DearXComma = "Caro(a) %s,";
$UserLinkingRequests = "Requisições de Ligação a Usuários";
$NewHomeworkEmailAlertToHrmEnable = "Enviar E-mail para alunos e seus Gerentes de RH na criação de tarefas";
$UserLinkingRequestAccepted = "Requisição de Ligação ao Usuários Aceita";
$UserLinkingTo = "Ligado ao Aluno";
$RequestLinkingToUser = "Requerer ligação com o aluno";
$LinkingRequestsAdded = "Requerimento de Ligação adicionado";
$HrmList = "Lista de Gerentes de Recursos Humanos";
$AssignHrmToUser = "Atribuir Gerente de Recursos Humanos ao usuário";
$AddHrmToUser = "Adicionar Gerente de Recursos Humanos ao usuário";
$HrmAssignedUsersCourseList = "Lista de Cursos dos usuários atribuídos ao Gerente de RH";
$GoToSurvey = "Ir para a pesquisa";
$NotificationCertificateSubject = "Notificação de Certificado";
$NotificationCertificateTemplate = "((user_first_name)), Congratulações por completar o ((course_title)). Sua nota final para este curso é ((score)). Por favor aguarde alguns dias para isso refletir no sistema do curso. Aguardamos ansiosos em ver você em próximos cursos. Se pudermos ajudar em qualquer assunto, por favor sinta-se livre para entrar em contato. Atenciosamente, ((author_first_name)), ((author_last_name)) ((portal_name))";
$SendCertificateNotifications = "Enviar notificação de certificado para todos os usuários";
$MailSubjectForwardShort = "Enc";
$ForwardedMessage = "Mensagem encaminhada";
$ForwardMessage = "Encaminhar Mensagem";
$MyCoursePageCategoryIntroduction = "Você vai encontrar abaixo a lista de categorias de cursos. Clique em uma delas para ver a lista de cursos disponíveis nela.";
$FeatureDisabledByAdministrator = "Funcionalidade desabilitada pelo Administrador";
$SubscribeUsersToLpCategory = "Inscrever usuários na categoria";
$SubscribeGroupsToLpCategory = "Inscrever grupos na categoria";
$UserLpSubscriptionDescription = "Descrição da assinatura do UserL";
$UserLpCategorySubscriptionDescription = "Descrição da Lp Subscrição de Categoria de Usuário";
$FieldTypeSelectWithTextField = "Selecione com campo de texto";
$FieldTypeTripleSelect = "Seleção tripla";
$DoubleValidationMessage = "Mensagem de Validação Dupla";
$AddText = "Add texto";
$OralExpressionHelpText = "Texto de Ajuda de Expressão Oral";
$BestScoreInLearningPath = "Melhor pontuação no caminho de aprendizagem";
$BestScoreNotInLearningPath = "Melhor pontuação não em caminho de aprendizagem";
$ReSendConfirmationMail = "Enviar novamente o e-mail de confirmação";
$UserConfirmedNowYouCanLogInThePlatform = "Usuário confirmado. Agora você pode entrar na plataforma.";
$AgendaAvailableInCourseX = "Agenda disponível no curso %s";
