...
$IfYouContinueYourAnswerWillBeSavedAnyChangeWillBeNotAllowed = "Si vous continuez, votre réponse sera sauvée et définitive. Toute modification ultérieure sera refusée.";
...
$AreYouSureToDeleteSteps = "Êtes-vous certain de vouloir supprimer ces étapes?";
$Origin = "Origine";
$Local = "Local";
$Remote = "Distant";
...
$ThisItemIsNotExportable = "Cet objet n'est pas compatible SCORM pour le moment. C'est pourquoi il n'est pas exportable.";
...
$WarningResponsible = "N'utilisez ce script qu'après avoir fait une sauvegarde. Chamilo ne pourrait être tenu responsable de perte ou de corruption de vos données.";
...
$Publish = "Publier";
$Scormcontentstudent = "Ceci est un cours au format SCORM. Si vous souhaitez le lancer, cliquez ici : <input type=button name=scormbutton value='Exécuter' ='openscorm()'>";
$Scormcontent = "Ceci est un contenu SCORM<br /><input type=button name=scormbutton value='Exécuter' ='openscorm()'>";
...
$MetaTwitterCreatorComment = "Le Twitter Creator est un compte Twitter (ex. @ywarnier) qui représente par exemple la \"personne\" qui a créé le site. Ce champ est facultatif.";
...
$RegistrationRequiredFormsComment = "Quels champs doivent être obligatoirement complétés (en plus de nom, prénom, nom d'utilisateur et mot de passe)";
...
$DropboxAllowOverwriteComment = "Le document d'origine peut-il être écrasé lorsqu'un utilisateur transfère un document portant le même nom ? En répondant OUI, vous perdez la possibilité de conserver les versions successives du document";
...
$ExtendedProfileComment = "Si \"Oui\" est coché, l'utilisateur pourra compléter les champs facultatifs suivants: \"Mes compétences\", \"Mes diplômes\", \"Mes compétences professionnelles\", \"Mon espace personnel\"";
$Classes = "Classes";
...
$BreadCrumbsCourseHomepageTitle = "\"Mies de pain\" (\"breadcrumb\") de la page d'accueil de cours";
$BreadCrumbsCourseHomepageComment = "Les \"mies de pain\" (\"breadcrumb\") sont la navigation horizontale par liens qui s'affiche généralement en haut à gauche de la page. Cette option vous permet de choisir ce que ce lien affichera.";
...
$Ajax_course_tracking_refresh_comment = "Cette option permet, en temps réel, de calculer le temps qu'un utilisateur passe sur un cours. La valeur à indiquer dans ce champ est l'intervalle de rafraîchissement en secondes. Pour désactiver cette option, laissez la valeur à 0.";
...
$PlatformCharsetComment = "La palette de caractères est ce qui détermine la façon dont certaines chaînes de caractères de langues spécifiques sont affichées. Si vous utilisez le russe ou le japonais par exemple, vous aurez certainement besoin de modifier cette variable. Pour toutes les langues anglaises, latines et ouest-européennes, le défaut UTF-8 devrait être parfaitement adapté.";
$ExtendedProfileRegistrationTitle = "Champs du profil étendu lors de l'enregistrement";
$ExtendedProfileRegistrationComment = "Parmi les champs suivants du profil étendu, lesquels doivent être disponibles lors du processus d'enregistrement des utilisateurs? Ceci nécessite que le profil étendu lors de l'enregistrement soit activé (voir plus haut).";
$ExtendedProfileRegistrationRequiredTitle = "Champs du profil étendu demandés lors de l'enregistrement";
$ExtendedProfileRegistrationRequiredComment = "Parmi les champs du profil étendun lesquels sont requis lors de l'enregistrement des utilisateurs? Ceci nécessite que l'option du profil étendu à l'enregistrement soit activée et que les champs soient disponibles dans le formulaire d'inscription (voir ci-dessus).";
...
$CourseCoachEmailSender = "Adresse de courriel du coach/tuteur";
...
$FieldPossibleValuesComment = "Uniquement pour champs répétitifs, séparés par des point-virgules (;)";
$FieldTypeDate = "Date";
...
$LDAPAuthenticationLoginComment = "Dans le cas d'un serveur LDAP n'autorisant pas les accès anonymes, complétez le champ suivant avec le nom d'utilisateur ayant accès au système. N'incluez pas de \"cn=\". Laissez vide pour le mode anonyme.";
$LDAPAuthenticationPasswordTitle = "Mot de passe d'authentification";
$LDAPAuthenticationPasswordComment = "Dans le cas d'un serveur LDAP n'autorisant pas les accès anonymes, complétez le champ suivant avec le mot de passe de l'utilisateur ayant accès au système.";
...
$URLEdited = "L'URL a été mise à jour";
...
$EncryptMethodUserPass = "Méthode de cryptage";
...
$InC = "dans ce cours";
$Filled = "Vous n'avez pas complété tous les champs.";
...
$State = "Etat";
$GroupFilledGroups = "Les groupes ont été complétés par les utilisateurs figurant dans la liste 'Utilisateurs'.";
...
$GroupAllowStudentUnregistration = "Les utilisateurs sont autorisés à annuler leur inscription aux groupes.";
...
$SelectedGroupsFilled = "Tous les groupes sélectionnés ont été complétés";
...
$LearnpathAddTitleAndDesc = "Éditer nom et descr.";
...
$LearnpathEditLearnpath = "Éditer le nom et/ou la description du parcours";
...
$LearnpathEditModule = "Éditer le nom et/ou la description du chapitre";
...
$EditPrerequisites = "Éditer les pré-requis pour cette étape";
...
$EditCurrentLink = "Éditer le lien";
...
$FillLists = "Veuillez compléter les deux listes ci-dessous";
...
$HotspotError = "Veuillez compléter description et score pour chaque zone.";
...
$RandomQuestionsHelp = "Nombre de questions qui seront tirées aléatoirement parmi les questions du test. Choisissez \"non\" pour ne pas les tirer aléatoirement. <br/>Choisissez le nombre total de questions pour les désordonner toutes.";
...
$FieldMadeChangeable = "Le champ est à présent modifiable par l'utilisateur: celui-ci pourra compléter ou modifier le champ";
$CannotMakeFieldChangeable = "Impossible de rendre le champ modifiable.";
$FieldMadeUnchangeable = "Le champ est à présent non-modifiable: l'utilisateur ne pourra pas le compléter ou le modifier.";
...
$SearchPrefilterPrefixComment = "Cette option vous permet de choisir le champ spécifique à utiliser dans la recherche de type pré-filtre, où le premier champ de déterminer dynamiquement le contenu des suivants.";
...
$IfYouWantToAddManyUsers = "Si vous voulez ajouter une liste des utilisateurs de votre cours, contactez votre administrateur web.";
...
$Options = "Options";
$WelcomeOogieConverter = "Bienvenue dans Chamilo RAPID<ul type=\"1\"><li>Choisissez un fichier .ppt ou .odp<li>Envoyez ce fichier à Oogie. Il sera converti en parcours SCORM<li>Vous pourrez ensuite ajouter des commentaires audio sur chaque dia et insérer tests et activités entres les dias</ul>";
...
$CareerXUnarchived = "La carrière <i>%s</i> a été réactivée. Cette action a pour conséquence de rendre visibles la carrière, les promotions qui y sont enregistrées et les sessions qui sont enregistrées dans celles-ci. Vous pouvez annuler cette action en archivant la carrière.";
$SeeAll = "Tout voir";
