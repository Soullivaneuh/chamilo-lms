...
$WorkEmailAlert = "E-mail on assignments submission by students";
$WorkEmailAlertActivate = "E-mail students and teachers on new assignment submission";
$WorkEmailAlertDeactivate = "Disable e-mail alert on new assignment submission";
$DropboxEmailAlert = "E-mail users on dropbox file reception";
$DropboxEmailAlertActivate = "E-mail users on dropbox files reception";
$DropboxEmailAlertDeactivate = "Disable e-mail alert on dropbox files reception";
...
$NewUserEmailAlert = "E-mail teacher when a new user auto-subscribes";
$NewUserEmailAlertEnable = "E-mail the teacher when a new user auto-subscribes";
$NewUserEmailAlertToTeacharAndTutor = "E-mail teacher and tutors when new user auto-subscribes";
$NewUserEmailAlertDisable = "Disable e-mail alert to teacher on auto-subscription";
...
$Only = "Only";
$RandomLanguage = "Shuffle selection in available languages";
...
$Publish = "Publish";
$Scormcontentstudent = "This is a SCORM course. To play it, click here : <input type=button name=scormbutton value='Launch it !' ='openscorm()'>";
$Scormcontent = "This is a SCORM content<br><input type=button name=scormbutton value='Launch it !' ='openscorm()'>";
...
$NotScormContent = "This is not a valid SCORM ZIP file !";
...
$SurveyEmailSenderNoReplyComment = "Should the survey invitations use the coach e-mail address or the no-reply address defined in the main configuration section?";
...
$OogieBadExtension = "Please upload presentations only. Filename extension should be .ppt or .odp";
$WoogieBadExtension = "Please upload text documents only. Filename extension should be .doc, .docx or .odt";
...
$OnlyJPG = "For hotspots you can only use JPEG (.jpg or .jpeg) images";
...
$SpecificSearchFieldsIntro = "Here you can define the fields you want to use for indexing content. When you are indexing one element you should add one or many terms on each field comma-separated.";
...
$UserAddExplanation = "Every line of file to send will necessarily and only include 5 fields: <b>First name   LastName   Login   Password   E-mail</b> tab-separated and in this order. Users will receive an e-mail confirmation with their login/password.";
...
$NotifyDiscussByEmail = "Notify by e-mail of new comments about this page is allowed";
...
$MultipleEmails = "Accounts with same <i>e-mail</i>";
...
$Options = "Options";
$WelcomeOogieConverter = "Welcome to Chamilo RAPID<ul type=\"1\"><li>Browse your hard disk to find any .ppt or .odp file<li>Upload it to Oogie. It will convert it into a SCORM course.<li>You will then be allowed to add audio comments on each slide and insert test and activities between slides.";
...
$Keyword = "Keyword";
$KeywordTip = "comma-separated (letters, digits, -.)";
$Coverage = "Coverage";
...
$Answered = "Answered";
$AdditonalUsersComment = "You can invite additional users to fill the survey. To do so you can type their e-mail addresses here separated by either , (comma) or ; (semi-column)";
...
$ReminderResendToAllUsers = "Remind all users of the survey. If you do not check this checkbox only the newly-added users will receive an e-mail.";
...
$DescriptionContent = "<p>The Course Description tool prompts you to comprehensively describe your course in a systematic way. This description can be used to provide learners with an overview of what awaits them, and can be helpful when you review and evaluate your course. </p> The items merely offer suggestions. If you want to write your own course description, simply create your own headings and descriptions by selecting the  'Other' tool. </p> Otherwise, to complete a description of the course, click on each image, fill it with your text/content and submit. </p>";
...
$Letters = "Letters";
$NewHomeworkEmailAlert = "E-mail students on assignment creation";
$NewHomeworkEmailAlertEnable = "E-mail students on assignments creation";
$NewHomeworkEmailAlertDisable = "Disable e-mail notification on assignment creation";
