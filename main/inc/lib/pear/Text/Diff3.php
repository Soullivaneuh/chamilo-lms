...
class Text_Diff3 extends Text_Diff
{
     ...
     */
    public function Text_Diff3($orig, $final1, $final2)
    {
...
class Text_Diff3_Op
{
    public function Text_Diff3_Op($orig = false, $final1 = false, $final2 = false)
    {
        $this->orig = $orig ? $orig : [];
...
{
    public function Text_Diff3_Op_Copy($lines = false)
    {
...
{
    public function Text_Diff3_BlockBuilder()
    {
        $this->_init();
    }
