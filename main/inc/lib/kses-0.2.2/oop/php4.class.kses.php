        ...
        */
        class kses4
        {
            ...
            public function kses4()
            {
                 ...
                 */
                $this->allowed_protocols = ['http', 'ftp', 'mailto'];
                $this->allowed_html      = [];
            }
             ...
             *	@since PHP4 OOP 0.0.1
             */
            public function AddHTML($tag = "", $attribs = [])
            {
                if (!is_string($tag)) {
            ...
            public function RemoveProtocol($protocol = "")
            {
                ...
                if (in_array($protocol, $this->allowed_protocols)) {
                    $this->allowed_protocols = array_diff($this->allowed_protocols, [$protocol]);
                    sort($this->allowed_protocols);
                }
             ...
             *	@since PHP4 OOP 0.0.1
             */
            public function _no_null($string)
            {
             ...
             *	@since PHP4 OOP 0.0.1
             */
            public function _js_entities($string)
            {
             ...
             *	@since PHP4 OOP 0.0.1
             */
            public function _normalize_entities($string)
            {
             ...
             *	@since PHP4 OOP 0.0.1
             */
            public function _normalize_entities2($i)
            {
                return (($i > 65535) ? "&amp;#$i;" : "&#$i;");
            }
             ...
             */
            public function filterKsesTextHook($string)
            {
                return $string;
            }
             ...
             *	@since PHP4 OOP 0.0.1
             */
            public function _array_lc($inarray)
            {
                $outarray = [];
             ...
             *	@since PHP4 OOP 0.0.1
             */
            public function _split2($string)
            {
             ...
             *	@since PHP4 OOP 0.0.1
             */
            public function _attr($element, $attr)
            {
             ...
             *	@since PHP4 OOP 0.0.1
             */
            public function _bad_protocol($string)
            {
                $string  = $this->_no_null($string);
             ...
             *	@since PHP4 OOP 0.0.1
             */
            public function _bad_protocol_once($string)
            {
             ...
             *	@since PHP4 OOP 0.0.1
             */
            public function _bad_protocol_once2($string)
            {
             ...
             *	@since PHP4 OOP 0.0.1
             */
            public function _check_attr_val($value, $vless, $checkname, $checkvalue)
            {
                $ok = true;
             ...
             *	@since PHP4 OOP 0.0.1
             */
            public function _html_error($string)
            {
                return preg_replace('/^("[^"]*("|$)|\'[^\']*(\'|$)|\S)*\s*/', '', $string);
            }
             ...
             *	@since PHP4 OOP 0.0.1
             */
            public function _decode_entities($string)
            {
