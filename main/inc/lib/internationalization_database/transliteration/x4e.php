<?php
// $Id: x4e.php,v 1.1.8.1 2008/06/12 20:34:31 smk Exp $

return [
  'en' => [null, 'Ding ', 'Kao ', 'Qi ', 'Shang ', 'Xia ', null, 'Mo ', 'Zhang ', 'San ', 'Shang ', 'Xia ', 'Ji ', 'Bu ', 'Yu ', 'Mian ',
    ...
    'Fu ', 'Yi ', 'Yi ', 'Nai ', 'Shime ', 'Jiu ', 'Jiu ', 'Zhe ', 'Yao ', 'Yi ', null, 'Zhi ', 'Wu ', 'Zha ', 'Hu ', 'Fa ',
    'Le ', 'Zhong ', 'Ping ', 'Pang ', 'Qiao ', 'Hu ', 'Guai ', 'Cheng ', 'Cheng ', 'Yi ', 'Yin ', null, 'Mie ', 'Jiu ', 'Qi ', 'Ye ',
    'Xi ', 'Xiang ', 'Gai ', 'Diu ', 'Hal ', null, 'Shu ', 'Twul ', 'Shi ', 'Ji ', 'Nang ', 'Jia ', 'Kel ', 'Shi ', null, 'Ol ',
    'Mai ', 'Luan ', 'Cal ', 'Ru ', 'Xue ', 'Yan ', 'Fu ', 'Sha ', 'Na ', 'Gan ', 'Sol ', 'El ', 'Cwul ', null, 'Gan ', 'Chi ',
    'Gui ', 'Gan ', 'Luan ', 'Lin ', 'Yi ', 'Jue ', 'Liao ', 'Ma ', 'Yu ', 'Zheng ', 'Shi ', 'Shi ', 'Er ', 'Chu ', 'Yu ', 'Yu ',
    'Yu ', 'Yun ', 'Hu ', 'Qi ', 'Wu ', 'Jing ', 'Si ', 'Sui ', 'Gen ', 'Gen ', 'Ya ', 'Xie ', 'Ya ', 'Qi ', 'Ya ', 'Ji ',
    'Tou ', 'Wang ', 'Kang ', 'Ta ', 'Jiao ', 'Hai ', 'Yi ', 'Chan ', 'Heng ', 'Mu ', null, 'Xiang ', 'Jing ', 'Ting ', 'Liang ', 'Xiang ',
    ...
    'Gan ', 'Yi ', 'Di ', 'Dai ', 'Ling ', 'Yi ', 'Chao ', 'Chang ', 'Sa ', null, 'Yi ', 'Mu ', 'Men ', 'Ren ', 'Jia ', 'Chao ',
