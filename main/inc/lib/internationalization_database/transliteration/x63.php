<?php
// $Id: x63.php,v 1.1.8.1 2008/06/12 20:34:31 smk Exp $

return [
  'en' => ['Bo ', 'Chi ', 'Gua ', 'Zhi ', 'Kuo ', 'Duo ', 'Duo ', 'Zhi ', 'Qie ', 'An ', 'Nong ', 'Zhen ', 'Ge ', 'Jiao ', 'Ku ', 'Dong ',
    ...
    'Bang ', 'Jian ', 'Huan ', 'Dao ', null, 'Wan ', 'Qin ', 'Peng ', 'She ', 'Lie ', 'Min ', 'Men ', 'Fu ', 'Bai ', 'Ju ', 'Dao ',
    ...
    'Bai ', 'Shou ', 'Jie ', 'Lu ', 'Guo ', 'Haba ', null, 'Zhi ', 'Dan ', 'Mang ', 'Xian ', 'Sao ', 'Guan ', 'Peng ', 'Yuan ', 'Nuo ',
    ...
    'Chong ', 'Shuo ', 'She ', 'Xie ', 'Yuan ', 'Qian ', 'Ye ', 'Cha ', 'Zha ', 'Bei ', 'Yao ', null, null, 'Lan ', 'Wen ', 'Qin '],
];
