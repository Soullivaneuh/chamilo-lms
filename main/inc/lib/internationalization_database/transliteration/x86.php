<?php
// $Id: x86.php,v 1.1.8.1 2008/06/12 20:34:31 smk Exp $

return [
  'en' => ['Tuo ', 'Wu ', 'Rui ', 'Rui ', 'Qi ', 'Heng ', 'Lu ', 'Su ', 'Tui ', 'Mang ', 'Yun ', 'Pin ', 'Yu ', 'Xun ', 'Ji ', 'Jiong ',
    'Xian ', 'Mo ', 'Hagi ', 'Su ', 'Jiong ', null, 'Nie ', 'Bo ', 'Rang ', 'Yi ', 'Xian ', 'Yu ', 'Ju ', 'Lian ', 'Lian ', 'Yin ',
    ...
    'Ji ', 'Kui ', 'Lu ', 'Jian ', 'San ', null, 'Lei ', 'Quan ', 'Xiao ', 'Yi ', 'Luan ', 'Men ', 'Bie ', 'Hu ', 'Hu ', 'Lu ',
    ...
    'Cheng ', 'Shi ', null, 'Di ', 'Zhe ', 'She ', 'Yu ', 'Gan ', 'Zi ', 'Hong ', 'Hui ', 'Meng ', 'Ge ', 'Sui ', 'Xia ', 'Chai ',
