<?php
// $Id: x6d.php,v 1.1.8.1 2008/06/12 20:34:31 smk Exp $

return [
  'en' => ['Zhou ', 'Ji ', 'Yi ', 'Hui ', 'Hui ', 'Zui ', 'Cheng ', 'Yin ', 'Wei ', 'Hou ', 'Jian ', 'Yang ', 'Lie ', 'Si ', 'Ji ', 'Er ',
    ...
    'Wei ', 'Wo ', 'Yun ', 'Huan ', 'Di ', null, 'Run ', 'Jian ', 'Zhang ', 'Se ', 'Fu ', 'Guan ', 'Xing ', 'Shou ', 'Shuan ', 'Ya ',
