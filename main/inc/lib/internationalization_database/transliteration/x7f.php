<?php
// $Id: x7f.php,v 1.1.8.1 2008/06/12 20:34:31 smk Exp $
...
return [
  'en' => ['Zhui ', 'Zi ', 'Ke ', 'Xiang ', 'Jian ', 'Mian ', 'Lan ', 'Ti ', 'Miao ', 'Qi ', 'Yun ', 'Hui ', 'Si ', 'Duo ', 'Duan ', 'Bian ',
    ...
    null, 'Gang ', 'Ying ', 'Ying ', 'Qing ', 'Xia ', 'Guan ', 'Zun ', 'Tan ', 'Chang ', 'Qi ', 'Weng ', 'Ying ', 'Lei ', 'Tan ', 'Lu ',
    'Guan ', 'Wang ', 'Wang ', 'Gang ', 'Wang ', 'Han ', null, 'Luo ', 'Fu ', 'Mi ', 'Fa ', 'Gu ', 'Zhu ', 'Ju ', 'Mao ', 'Gu ',
    ...
    'Han ', 'Ao ', 'Piao ', 'Yi ', 'Lian ', 'Qu ', null, 'Lin ', 'Pen ', 'Qiao ', 'Ao ', 'Fan ', 'Yi ', 'Hui ', 'Xuan ', 'Dao '],
];
