<?php
// $Id: x33.php,v 1.1.8.1 2008/06/12 20:34:31 smk Exp $

return [
  'en' => ['apartment', 'alpha', 'ampere', 'are', 'inning', 'inch', 'won', 'escudo', 'acre', 'ounce', 'ohm', 'kai-ri', 'carat', 'calorie', 'gallon', 'gamma',
    ...
    '24h', 'HPA', 'da', 'AU', 'bar', 'oV', 'pc', null, null, null, null, 'Heisei', 'Syouwa', 'Taisyou', 'Meiji', 'Inc.',
    ...
    'lm', 'ln', 'log', 'lx', 'mb', 'mil', 'mol', 'pH', 'p.m.', 'PPM', 'PR', 'sr', 'Sv', 'Wb', null, null,
