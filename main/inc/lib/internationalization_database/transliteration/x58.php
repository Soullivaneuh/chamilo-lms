<?php
// $Id: x58.php,v 1.1.8.1 2008/06/12 20:34:31 smk Exp $

return [
  'en' => ['Ku ', 'Ke ', 'Tang ', 'Kun ', 'Ni ', 'Jian ', 'Dui ', 'Jin ', 'Gang ', 'Yu ', 'E ', 'Peng ', 'Gu ', 'Tu ', 'Leng ', null,
    'Ya ', 'Qian ', null, 'An ', null, 'Duo ', 'Nao ', 'Tu ', 'Cheng ', 'Yin ', 'Hun ', 'Bi ', 'Lian ', 'Guo ', 'Die ', 'Zhuan ',
    ...
    'Pyeng ', 'Toride ', 'Xiang ', 'Huang ', 'Leng ', 'Duan ', null, 'Xuan ', 'Ji ', 'Ji ', 'Kuai ', 'Ying ', 'Ta ', 'Cheng ', 'Yong ', 'Kai ',
    ...
    'Jin ', 'Di ', 'Shang ', 'Mu ', 'Cui ', 'Yan ', 'Ta ', 'Zeng ', 'Qi ', 'Qiang ', 'Liang ', null, 'Zhui ', 'Qiao ', 'Zeng ', 'Xu ',
    ...
    'Long ', 'Rui ', 'Li ', 'Lin ', 'Rang ', 'Ten ', 'Xun ', 'Yan ', 'Lei ', 'Ba ', null, 'Shi ', 'Ren ', null, 'Zhuang ', 'Zhuang ',
